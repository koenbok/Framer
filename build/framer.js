...
require.define("/src/animation.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var AnimatableFilterProperties, Animation, AnimationCounter, AnimationList, Color, EventEmitter, FilterProperties, Matrix, bezier, config, css, k, parseCurve, spring, utils, v, _,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Animation = (function(_super) {
    ...
    Animation.prototype._keyFrames = function() {
      var colorA, colorB, currentKeyFrame, curveValue, deltas, keyFrames, position, propertyName, stepDelta, stepIncrement, _i, _len, _ref;
      stepIncrement = 0;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for (propertyName in this.propertiesA) {
          if (propertyName === "color" || propertyName === "backgroundColor") {
            colorA = Color(this.propertiesA[propertyName]);
            colorB = Color(this.propertiesB[propertyName]);
            console.log(curveValue);
            currentKeyFrame[propertyName] = "rgb(" + (utils.round(255 * curveValue / 100.0, 0)) + ",0,0)";
          } else {
    ...
    Animation.prototype._css = function() {
      ...
      for (position in keyFrames) {
        ...
        for (propertyName in _ref2) {
          ...
          cssString.push("" + propertyName + ":" + values[propertyName] + unit + "; ");
        }
        cssString.push("}\n");
      }
      cssString.push("}\n");
...
require.define("/node_modules/color/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./color"}
});

require.define("/node_modules/color/color.js",function(require,module,exports,__dirname,__filename,process,global){/* MIT license */
...
require.define("/node_modules/color/node_modules/color-convert/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./index"}
});

require.define("/node_modules/color/node_modules/color-convert/index.js",function(require,module,exports,__dirname,__filename,process,global){var conversions = require("./conversions");
...
require.define("/node_modules/color/node_modules/color-convert/conversions.js",function(require,module,exports,__dirname,__filename,process,global){/* MIT license */
...
require.define("/node_modules/color/node_modules/color-string/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./color-string"}
});

require.define("/node_modules/color/node_modules/color-string/color-string.js",function(require,module,exports,__dirname,__filename,process,global){/* MIT license */
var convert = require("color-convert");
