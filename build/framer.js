// Framer 2.0-67-g5f43831 (c) 2013 Koen Bok
// https://github.com/koenbok/Framer

window.FramerVersion = "2.0-67-g5f43831";
...
require.define("/src/views/view.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var Animation, EventEmitter, FilterProperties, Frame, Matrix, View, config, k, utils, v, _,
  ...
  View = (function(_super) {
    ...
    function View(args) {
      ...
      this.style.backgroundColor = config.defaultViewBackgroundColor;
    ...
    View.define("draggable", {
      get: function() {
        if (this._draggable == null) {
          this._draggable = new ui.Draggable(this);
        }
