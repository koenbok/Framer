...
describe "Layer", ->
	...
	describe "Properties", ->
		...
		it "should set x and y", ->
			...
			layer.style.webkitTransform.should.equal "translate3d(100px, 50px, 0px) scale(1) scale3d(1, 1, 1) skew(0deg) rotateX(0deg) rotateY(0deg) rotateZ(0deg)"
		...
		it "should set scale", ->
			...
			layer.style.webkitTransform.should.equal "translate3d(0px, 0px, 0px) scale(1) scale3d(100, 100, 100) skew(0deg) rotateX(0deg) rotateY(0deg) rotateZ(0deg)"
